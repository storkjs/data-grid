...
this.onScrollY(clickedItemY-this.dataViewHeight+this.rowHeight)),this.repositionTables(null,null,!0),this.renderSelectOnRows(),this._dispatchSelectEvent("select",this.clickedItem.dataIndex,this.clickedItem.column,trackByData)}},root.storkGrid=storkGrid}(window);
